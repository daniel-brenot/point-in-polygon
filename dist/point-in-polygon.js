...
*/
function pointInPolygon(point, vertices, usePointOnVertex, minX, maxX, minY, maxY) {
    //Checks if the point is in the basic boundary. Saves on procssing power
    if (usePointOnVertex == undefined)
        usePointOnVertex = true;
...
exports.pointOnVertex = pointOnVertex;
